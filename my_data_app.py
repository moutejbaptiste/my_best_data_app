...
# ---------- Onglet 2 : Importer CSV ----------
with tabs[1]:
    st.header("Importer CSV existants")
    uploaded_files = st.file_uploader("Sélectionner vos CSV", type=["csv"], accept_multiple_files=True)
    if st.button("Importer CSV dans la DB"):
        total_rows = 0
